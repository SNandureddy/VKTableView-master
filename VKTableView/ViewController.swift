...
@IBOutlet weak var menuHeightConstraint: NSLayoutConstraint!
    ...
    func prepareTeamInfoData() -> [[TeamInfoCellData]]{
        ...
        let bangladeshArray = [TeamInfoCellData]()
        let saArray = [TeamInfoCellData]()
        let srilankaArray = [TeamInfoCellData]()
        let newZealandArray = [TeamInfoCellData]()
        let englandArray = [TeamInfoCellData]()
